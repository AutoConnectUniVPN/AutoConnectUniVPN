...
Damit die App funktioniert, braucht man Folgendes:
 ...
 - Cisco darf **_nicht_** im Autostart liegen oder vorher gestartet werden!!! Ansonsten bleibt Auto Connect Uni VPN hängen. 
   Nach dem Entfernen aus dem Autostart PC neu starten nicht vergessen
...
[Download Windows Version 1.0.0](_Downloads/Setup_AutoConnectUniVPN_1.0.1.exe)
...
wie das im Source Code, trotzdem ist es mit genügend krimineller Energie durch Reverse Engineering möglich
